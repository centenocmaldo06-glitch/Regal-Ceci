...
moon.addEventListener("click", () => {
    ...
    createSpark(
        moon.offsetLeft + moon.offsetWidth / 2,
        moon.offsetTop + moon.offsetHeight / 2
    );

    if (moonClicks >= 5 && secretMessage) {

        secretMessage.style.opacity = "0";
        secretMessage.style.transform = "translateY(20px)";
        secretMessage.style.transition = "all .8s ease";
...
Gracias por llegar
hasta el final de este pequeño regalo.

<br><br>

Espero haberte sacado
una sonrisa.
